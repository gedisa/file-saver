        ...
        try {
            ...
            when (call.method) {
                ...
                "saveAs" -> {
                    ...
                    dialog!!.openFileManager(fileName = call.argument("name"), bytes = call.argument("bytes"), type = call.argument("type"), result = result, requestCode = call.argument("requestCode"))
                }
                else -> {
